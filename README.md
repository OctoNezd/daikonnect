...
![tray icon](misc/menubar.png)

**OTP Notification with copy code button!**

![otp notification with button to copy code](misc/otppush.png)

**Control music on your Mac from your phone!**

![phone notification screen showing music playback notification from mac](misc/phone_music_ctl.jpg)
